...
class Order(Document):
    ...
    def on_submit(self):
        ...
        self.add_comment('Info', 'Order submitted')
    ...
    def update_book_stock(self):
        ...
        for item in self.order_items:
            ...
            # Add a comment about stock update
            self.add_comment('Info', 
                f'Updated stock for book {book.book_name}: -{item.num} units'
            )
    ...
    def revert_book_stock(self):
        ...
        for item in self.order_items:
            ...
            # Add a comment about stock reversion
            self.add_comment('Info', 
                f'Reverted stock for book {book.book_name}: +{item.num} units'
            )